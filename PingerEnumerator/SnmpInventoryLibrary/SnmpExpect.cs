...
namespace SnmpInventoryLibrary
{
    class SnmpExpect
    {
        ...
        //-----------------------------------------------------------------------------
        //SNMPGET
        public string SnmpGet(string oidKey)
        {
        ...
        public string SnmpGet(string community, string ipAddress, string oidKey)
        {
            var result = Messenger.Get(VersionCode.V2,
        ...
        public string SnmpWalk(string community, string ipAddress, string oidKey)
        {
            var result = new List<Variable>();
            Messenger.Walk(VersionCode.V2,
                           new IPEndPoint(IPAddress.Parse(ipAddress), 161),
            ...
            {
                report.AppendLine(variable.Data.ToString());
            }
